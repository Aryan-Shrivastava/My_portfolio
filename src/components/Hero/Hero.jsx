    ...
    return (
        <div id="hero" className='hero'>
            ...
            <div className="hero-action">
                ...
                <a href="src\assets\Aryan_shrivastava_resume.pdf" target='_blank' rel="noopener noreferrer" className='hero-resume-link'><div className="hero-resume">My resume</div></a>
            </div>
        </div>
    )
}
